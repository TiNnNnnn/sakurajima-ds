...
const (
	LogOp_All LogOp = 0
	// 心跳
	LogOp_HeartBeat     LogOp = 1
	LogOp_AppendEntries LogOp = 2
	// Leader选举
	LogOp_StartElection LogOp = 3
	LogOp_RequestVote   LogOp = 4
	LogOp_RecvVote      LogOp = 5
	LogOp_Vote          LogOp = 6
	// 状态转换
	LogOp_ToCandiate LogOp = 7
	LogOp_ToFollow   LogOp = 8
	LogOp_ToLeader   LogOp = 9
	// 启动成功
	LogOp_StartSucess LogOp = 10
	// 监听配置变化
	LogOp_ListenConfigSuccess LogOp = 11
	LogOp_ListenConfigFailed  LogOp = 12
	LogOp_PutKv               LogOp = 13
	LogOp_GetKv               LogOp = 14
)
...
var (
	LogOp_name = map[int32]string{
		...
		9:  "ToLeader",
		10: "StartSucess",
		11: "ListenConfigSuccess",
		12: "ListenConfigFailed",
		13: "PutKv",
		14: "GetKv",
	}
...
const (
	LogLayer_ELSE    LogLayer = 0
	LogLayer_PERSIST LogLayer = 1
	LogLayer_RAFT    LogLayer = 2
	LogLayer_SERVICE LogLayer = 3
)

// Enum value maps for LogLayer.
var (
	LogLayer_name = map[int32]string{
		0: "ELSE",
		1: "PERSIST",
		2: "RAFT",
		3: "SERVICE",
	}
	LogLayer_value = map[string]int32{
		"ELSE":    0,
		"PERSIST": 1,
		"RAFT":    2,
		"SERVICE": 3,
...
func (x LogLayer) Enum() *LogLayer {
	p := new(LogLayer)
	*p = x
	return p
}

func (x LogLayer) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (LogLayer) Descriptor() protoreflect.EnumDescriptor {
	return file_tinnraft_proto_enumTypes[7].Descriptor()
}

func (LogLayer) Type() protoreflect.EnumType {
	return &file_tinnraft_proto_enumTypes[7]
}

func (x LogLayer) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use LogLayer.Descriptor instead.
func (LogLayer) EnumDescriptor() ([]byte, []int) {
...
type MigrateBucket struct {
	...
	From     int64 `protobuf:"varint,2,opt,name=from,proto3" json:"from,omitempty"` //源节点组
	To       int64 `protobuf:"varint,3,opt,name=to,proto3" json:"to,omitempty"`     //目标节点组
}

func (x *MigrateBucket) Reset() {
	*x = MigrateBucket{}
	if protoimpl.UnsafeEnabled {
...
func (x *MigrateBucket) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MigrateBucket) ProtoMessage() {}

func (x *MigrateBucket) ProtoReflect() protoreflect.Message {
	mi := &file_tinnraft_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MigrateBucket.ProtoReflect.Descriptor instead.
func (*MigrateBucket) Descriptor() ([]byte, []int) {
	return file_tinnraft_proto_rawDescGZIP(), []int{11}
}

func (x *MigrateBucket) GetBucketId() int64 {
	if x != nil {
		return x.BucketId
	}
	return 0
...
func (x *MigrateBucket) GetFrom() int64 {
	if x != nil {
		return x.From
	}
	return 0
...
func (x *MigrateBucket) GetTo() int64 {
	if x != nil {
		return x.To
	}
	return 0
...
type BucketOpReply struct {
	...
	ErrCode       int64  `protobuf:"varint,5,opt,name=ErrCode,proto3" json:"ErrCode,omitempty"`
}
...
func (x *BucketOpReply) GetLeaderId() int64 {
	if x != nil {
		return x.LeaderId
	}
	return 0
...
func (x *BucketOpReply) GetErrCode() int64 {
	if x != nil {
		return x.ErrCode
	}
	return 0
...
type MigrateArgs struct {
	...
	BucketData []byte `protobuf:"bytes,1,opt,name=BucketData,proto3" json:"BucketData,omitempty"`
	BucketId   int64  `protobuf:"varint,2,opt,name=BucketId,proto3" json:"BucketId,omitempty"`
}

func (x *MigrateArgs) Reset() {
	*x = MigrateArgs{}
	if protoimpl.UnsafeEnabled {
...
func (x *MigrateArgs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MigrateArgs) ProtoMessage() {}

func (x *MigrateArgs) ProtoReflect() protoreflect.Message {
	mi := &file_tinnraft_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MigrateArgs.ProtoReflect.Descriptor instead.
func (*MigrateArgs) Descriptor() ([]byte, []int) {
	return file_tinnraft_proto_rawDescGZIP(), []int{16}
}

func (x *MigrateArgs) GetBucketData() []byte {
	if x != nil {
		return x.BucketData
	}
	return nil
...
func (x *MigrateArgs) GetBucketId() int64 {
	if x != nil {
		return x.BucketId
	}
	return 0
...
type MigrateReply struct {
	...
	ErrMsg  int64 `protobuf:"varint,3,opt,name=ErrMsg,proto3" json:"ErrMsg,omitempty"`
}
...
func (x *MigrateReply) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *MigrateReply) GetErrCode() int64 {
	if x != nil {
		return x.ErrCode
	}
	return 0
...
func (x *MigrateReply) GetErrMsg() int64 {
	if x != nil {
		return x.ErrMsg
	}
	return 0
...
func (x *MetaReply) Reset() {
	*x = MetaReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tinnraft_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MetaReply) Descriptor() ([]byte, []int) {
	return file_tinnraft_proto_rawDescGZIP(), []int{24}
}
...
type LogArgs struct {
	...
	Layer    LogLayer `protobuf:"varint,5,opt,name=layer,proto3,enum=pbs.LogLayer" json:"layer,omitempty"`
	// raft层相关
	...
	PreState string `protobuf:"bytes,8,opt,name=preState,proto3" json:"preState,omitempty"` //之前的状态
	CurState string `protobuf:"bytes,9,opt,name=curState,proto3" json:"curState,omitempty"` //当前状态
	Term     int64  `protobuf:"varint,10,opt,name=term,proto3" json:"term,omitempty"`
	// service层相关
	BucketId string `protobuf:"bytes,11,opt,name=bucketId,proto3" json:"bucketId,omitempty"`
...
func (x *LogArgs) Reset() {
	*x = LogArgs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tinnraft_proto_msgTypes[25]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LogArgs) Descriptor() ([]byte, []int) {
	return file_tinnraft_proto_rawDescGZIP(), []int{25}
}
...
func (x *LogArgs) GetContents() string {
	if x != nil {
		return x.Contents
	}
	return ""
...
func (x *LogArgs) GetLayer() LogLayer {
	if x != nil {
		return x.Layer
	}
	return LogLayer_ELSE
}

func (x *LogArgs) GetFromId() string {
	if x != nil {
		return x.FromId
	}
	return ""
...
func (x *LogArgs) GetPreState() string {
	if x != nil {
		return x.PreState
	}
	return ""
...
func (x *LogArgs) GetCurState() string {
	if x != nil {
		return x.CurState
	}
	return ""
...
func (x *LogArgs) GetBucketId() string {
	if x != nil {
		return x.BucketId
	}
	return ""
...
func (x *LogArgs) GetGroupId() string {
	if x != nil {
		return x.GroupId
	}
	return ""
...
func (x *LogReply) Reset() {
	*x = LogReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tinnraft_proto_msgTypes[26]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LogReply) Descriptor() ([]byte, []int) {
	return file_tinnraft_proto_rawDescGZIP(), []int{26}
}

func (x *LogReply) GetErrcode() int64 {
	if x != nil {
		return x.Errcode
	}
	return 0
...
func (x *LogReply) GetErrMsg() string {
	if x != nil {
		return x.ErrMsg
	}
	return ""
...
var file_tinnraft_proto_rawDesc = []byte{
	...
	0x22, 0x4f, 0x0a, 0x0d, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x65, 0x42, 0x75, 0x63, 0x6b, 0x65,
	0x74, 0x12, 0x1a, 0x0a, 0x08, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x49, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x08, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x49, 0x64, 0x12, 0x12, 0x0a,
	...
	,
	...
	,
	...
	,
}
...
var file_tinnraft_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
var file_tinnraft_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_tinnraft_proto_goTypes = []interface{}{
	...
	(LogOp)(0),                   // 6: pbs.LogOp
	(LogLayer)(0),                // 7: pbs.LogLayer
	(*RequestVoteArgs)(nil),      // 8: pbs.RequestVoteArgs
	(*RequestVoteReply)(nil),     // 9: pbs.RequestVoteReply
	(*Entry)(nil),                // 10: pbs.Entry
	(*AppendEntriesArgs)(nil),    // 11: pbs.AppendEntriesArgs
	(*AppendEntriesReply)(nil),   // 12: pbs.AppendEntriesReply
	(*ApplyMsg)(nil),             // 13: pbs.ApplyMsg
	(*InstallSnapshotArgs)(nil),  // 14: pbs.InstallSnapshotArgs
	(*InstallSnapshotReply)(nil), // 15: pbs.InstallSnapshotReply
	(*CommandArgs)(nil),          // 16: pbs.CommandArgs
	(*CommandReply)(nil),         // 17: pbs.CommandReply
	(*ConfigArgs)(nil),           // 18: pbs.ConfigArgs
	(*MigrateBucket)(nil),        // 19: pbs.MigrateBucket
	(*ServerConfig)(nil),         // 20: pbs.ServerConfig
	(*ConfigReply)(nil),          // 21: pbs.ConfigReply
	(*BucketOpArgs)(nil),         // 22: pbs.BucketOpArgs
	(*BucketOpReply)(nil),        // 23: pbs.BucketOpReply
	(*MigrateArgs)(nil),          // 24: pbs.MigrateArgs
	(*MigrateReply)(nil),         // 25: pbs.MigrateReply
	(*Block)(nil),                // 26: pbs.Block
	(*DataBlocks)(nil),           // 27: pbs.DataBlocks
	(*MetaArgs2)(nil),            // 28: pbs.MetaArgs2
	(*MetaReply2)(nil),           // 29: pbs.MetaReply2
	(*MetaArgs)(nil),             // 30: pbs.MetaArgs
	(*Metadata)(nil),             // 31: pbs.Metadata
	(*MetaReply)(nil),            // 32: pbs.MetaReply
	(*LogArgs)(nil),              // 33: pbs.LogArgs
	(*LogReply)(nil),             // 34: pbs.LogReply
	nil,                          // 35: pbs.ConfigArgs.ServersEntry
	nil,                          // 36: pbs.ServerConfig.GroupsEntry
}
var file_tinnraft_proto_depIdxs = []int32{
	0,  // 0: pbs.Entry.Type:type_name -> pbs.EntryType
	10, // 1: pbs.AppendEntriesArgs.Entries:type_name -> pbs.Entry
	1,  // 2: pbs.CommandArgs.Op_type:type_name -> pbs.OpType
	35, // 3: pbs.ConfigArgs.Servers:type_name -> pbs.ConfigArgs.ServersEntry
	2,  // 4: pbs.ConfigArgs.OpType:type_name -> pbs.ConfigOpType
	36, // 5: pbs.ServerConfig.groups:type_name -> pbs.ServerConfig.GroupsEntry
	20, // 6: pbs.ConfigReply.Config:type_name -> pbs.ServerConfig
	3,  // 7: pbs.BucketOpArgs.BucketOpType:type_name -> pbs.BucketOpType
	26, // 8: pbs.DataBlocks.BlockList:type_name -> pbs.Block
	4,  // 9: pbs.MetaArgs2.OpType:type_name -> pbs.MetaOpType2
	27, // 10: pbs.MetaArgs2.BlockList:type_name -> pbs.DataBlocks
	5,  // 11: pbs.MetaArgs.op:type_name -> pbs.MetaOpType
	31, // 12: pbs.MetaReply.metas:type_name -> pbs.Metadata
	31, // 13: pbs.MetaReply.meta:type_name -> pbs.Metadata
	6,  // 14: pbs.LogArgs.Op:type_name -> pbs.LogOp
	7,  // 15: pbs.LogArgs.layer:type_name -> pbs.LogLayer
	8,  // 16: pbs.RaftService.RequestVote:input_type -> pbs.RequestVoteArgs
	11, // 17: pbs.RaftService.AppendEntries:input_type -> pbs.AppendEntriesArgs
	14, // 18: pbs.RaftService.Snapshot:input_type -> pbs.InstallSnapshotArgs
	16, // 19: pbs.RaftService.DoCommand:input_type -> pbs.CommandArgs
	18, // 20: pbs.RaftService.DoConfig:input_type -> pbs.ConfigArgs
	22, // 21: pbs.RaftService.DoBucket:input_type -> pbs.BucketOpArgs
	30, // 22: pbs.RaftService.DoMeta:input_type -> pbs.MetaArgs
	33, // 23: pbs.RaftService.DoLog:input_type -> pbs.LogArgs
	9,  // 24: pbs.RaftService.RequestVote:output_type -> pbs.RequestVoteReply
	12, // 25: pbs.RaftService.AppendEntries:output_type -> pbs.AppendEntriesReply
	15, // 26: pbs.RaftService.Snapshot:output_type -> pbs.InstallSnapshotReply
	17, // 27: pbs.RaftService.DoCommand:output_type -> pbs.CommandReply
	21, // 28: pbs.RaftService.DoConfig:output_type -> pbs.ConfigReply
	23, // 29: pbs.RaftService.DoBucket:output_type -> pbs.BucketOpReply
	32, // 30: pbs.RaftService.DoMeta:output_type -> pbs.MetaReply
	34, // 31: pbs.RaftService.DoLog:output_type -> pbs.LogReply
...
func file_tinnraft_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tinnraft_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tinnraft_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tinnraft_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
