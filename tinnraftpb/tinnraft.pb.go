...
var file_tinnraft_proto_rawDesc = []byte{
	...
	0x72, 0x4d, 0x73, 0x67, 0x2a, 0x2f, 0x0a, 0x09, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x54, 0x79, 0x70,
	...
	0x44, 0x61, 0x74, 0x61, 0x10, 0x02, 0x32, 0xec, 0x02, 0x0a, 0x0b, 0x52, 0x61, 0x66, 0x74, 0x53,
	...
	0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2e, 0x2f, 0x74, 0x69, 0x6e, 0x6e,
...
var file_tinnraft_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_tinnraft_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_tinnraft_proto_goTypes = []interface{}{
	...
	(*RequestVoteArgs)(nil),      // 4: pbs.RequestVoteArgs
	(*RequestVoteReply)(nil),     // 5: pbs.RequestVoteReply
	(*Entry)(nil),                // 6: pbs.Entry
	(*AppendEntriesArgs)(nil),    // 7: pbs.AppendEntriesArgs
	(*AppendEntriesReply)(nil),   // 8: pbs.AppendEntriesReply
	(*ApplyMsg)(nil),             // 9: pbs.ApplyMsg
	(*InstallSnapshotArgs)(nil),  // 10: pbs.InstallSnapshotArgs
	(*InstallSnapshotReply)(nil), // 11: pbs.InstallSnapshotReply
	(*CommandArgs)(nil),          // 12: pbs.CommandArgs
	(*CommandReply)(nil),         // 13: pbs.CommandReply
	(*ConfigArgs)(nil),           // 14: pbs.ConfigArgs
	(*ServerConfig)(nil),         // 15: pbs.ServerConfig
	(*ConfigReply)(nil),          // 16: pbs.ConfigReply
	(*BucketOpArgs)(nil),         // 17: pbs.BucketOpArgs
	(*BucketOpReply)(nil),        // 18: pbs.BucketOpReply
	nil,                          // 19: pbs.ConfigArgs.ServersEntry
	nil,                          // 20: pbs.ServerConfig.GroupsEntry
}
var file_tinnraft_proto_depIdxs = []int32{
	0,  // 0: pbs.Entry.Type:type_name -> pbs.EntryType
	6,  // 1: pbs.AppendEntriesArgs.Entries:type_name -> pbs.Entry
	1,  // 2: pbs.CommandArgs.Op_type:type_name -> pbs.OpType
	19, // 3: pbs.ConfigArgs.Servers:type_name -> pbs.ConfigArgs.ServersEntry
	2,  // 4: pbs.ConfigArgs.OpType:type_name -> pbs.ConfigOpType
	20, // 5: pbs.ServerConfig.groups:type_name -> pbs.ServerConfig.GroupsEntry
	15, // 6: pbs.ConfigReply.Config:type_name -> pbs.ServerConfig
	3,  // 7: pbs.BucketOpArgs.BucketOpType:type_name -> pbs.BucketOpType
	4,  // 8: pbs.RaftService.RequestVote:input_type -> pbs.RequestVoteArgs
	7,  // 9: pbs.RaftService.AppendEntries:input_type -> pbs.AppendEntriesArgs
	10, // 10: pbs.RaftService.Snapshot:input_type -> pbs.InstallSnapshotArgs
	12, // 11: pbs.RaftService.DoCommand:input_type -> pbs.CommandArgs
	14, // 12: pbs.RaftService.DoConfig:input_type -> pbs.ConfigArgs
	17, // 13: pbs.RaftService.DoBucket:input_type -> pbs.BucketOpArgs
	5,  // 14: pbs.RaftService.RequestVote:output_type -> pbs.RequestVoteReply
	8,  // 15: pbs.RaftService.AppendEntries:output_type -> pbs.AppendEntriesReply
	11, // 16: pbs.RaftService.Snapshot:output_type -> pbs.InstallSnapshotReply
	13, // 17: pbs.RaftService.DoCommand:output_type -> pbs.CommandReply
	16, // 18: pbs.RaftService.DoConfig:output_type -> pbs.ConfigReply
	18, // 19: pbs.RaftService.DoBucket:output_type -> pbs.BucketOpReply
