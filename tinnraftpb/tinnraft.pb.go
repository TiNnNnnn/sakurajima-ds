...
var file_tinnraft_proto_rawDesc = []byte{
	...
	0x05, 0x32, 0x86, 0x02, 0x0a, 0x0b, 0x52, 0x61, 0x66, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x32, 0x0a, 0x09, 0x44, 0x6f, 0x43, 0x6f, 0x6d, 0x6d,
	0x61, 0x6e, 0x64, 0x12, 0x10, 0x2e, 0x70, 0x62, 0x73, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e,
	0x64, 0x41, 0x72, 0x67, 0x73, 0x1a, 0x11, 0x2e, 0x70, 0x62, 0x73, 0x2e, 0x43, 0x6f, 0x6d, 0x6d,
	0x61, 0x6e, 0x64, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2e,
...
var file_tinnraft_proto_depIdxs = []int32{
	...
	10, // 6: pbs.RaftService.DoCommand:input_type -> pbs.CommandArgs
	3,  // 7: pbs.RaftService.RequestVote:output_type -> pbs.RequestVoteReply
	6,  // 8: pbs.RaftService.AppendEntries:output_type -> pbs.AppendEntriesReply
	9,  // 9: pbs.RaftService.Snapshot:output_type -> pbs.InstallSnapshotReply
	11, // 10: pbs.RaftService.DoCommand:output_type -> pbs.CommandReply
